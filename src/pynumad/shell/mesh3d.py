...
from pynumad.shell.spatialgridlist3d import *
            ...
            if interpMethod == "linear":
                ...
                for stg in range(0, stages):
                    ...
                    for ndi in range(0, nbNds):
                        ndDir[ndi] = (1.0 / sweepElements[stg]) * (
                            dNds[ndi] - prevDest[ndi]
                        )
                    for i in range(0, sweepElements[stg]):
                        ...
                        for fci in range(0, self.numBndFaces):
                            ...
                            if self.faceNodes[fci, 3] == -1:
                                ...
                                n5 = n2 + nbNds
                                n6 = n3 + nbNds
                                self.wedgeElements[wE] = np.array(
                                    [n1, n2, n3, n4, n5, n6]
                                )
                                wERank[wE] = eli
                                wE = wE + 1
